...
{
	public sealed partial class HeartRateGauge : UserControl
    {
        public HeartRateGauge()
        {
			InitializeComponent();
		...
		public static readonly DependencyProperty PercentValueProperty =
			DependencyProperty.Register("PercentValue", typeof(double), typeof(HeartRateGauge), new PropertyMetadata(0.0d));
		...
		public static readonly DependencyProperty MaxValueProperty =
			DependencyProperty.Register("MaxValue", typeof(double), typeof(HeartRateGauge), new PropertyMetadata(0.0d));
		...
		public static readonly DependencyProperty AverageValueProperty =
			DependencyProperty.Register("AverageValue", typeof(double), typeof(HeartRateGauge), new PropertyMetadata(0.0d));
	}
}
